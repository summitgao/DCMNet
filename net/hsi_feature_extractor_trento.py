...
class hsi_e(nn.Module):
    def __init__(self):
        ...
        #     torch.nn.Conv2d(kernel_size=3, in_channels=30, out_channels=32, padding=1),
        #
        ...
        #     torch.nn.Conv2d(kernel_size=1, in_channels=64, out_channels=args.hsi_channel, padding=0),
        #     nn.ReLU(inplace=True),
        #     nn.BatchNorm2d(num_features=args.hsi_channel))
